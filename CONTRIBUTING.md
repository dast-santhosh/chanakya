...
Thank you for your interest in contributing to Chanakya! This project thrives on community contributions — whether it's code, data sources, documentation, or bug reports.
...
Chanakya is a real-time OSINT dashboard built with **Vanilla TypeScript** (no UI framework), **MapLibre GL + deck.gl** for map rendering, and a custom Proto-first RPC framework called **Sebuf** for all API communication.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/<your-username>/chanakya.git
   cd chanakya
   ```
...
- **Internationalization** — help make Chanakya available in more languages
...
Use the [Bug Report issue template](https://github.com/dast-santhosh/chanakya/issues/new/choose) when available.
...
Use the [Feature Request issue template](https://github.com/dast-santhosh/chanakya/issues/new/choose) when available.
...
Thank you for helping make Chanakya better! 🌍
