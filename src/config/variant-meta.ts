...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Chanakya Dashboard - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://ajnav.com/',
    siteName: 'Chanakya Dashboard',
    shortName: 'ChanakyaDashboard',
