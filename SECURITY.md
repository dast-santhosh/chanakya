...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/dast-santhosh/chanakya/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@dast-santhosh](https://github.com/dast-santhosh) directly through GitHub.
